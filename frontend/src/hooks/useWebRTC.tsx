...
export const useWebRTC = (roomId: any, user: any) => {
    ...
    useEffect(() => {
        const initChat = async () => {
            ...
            socket.current.on(ACTIONS.MUTE_INFO, ({ userId, isMute }: any) => {
            ...
            async function handleRemovePeer({ peerId, userId }: any) {
                ...
                setClients((list: any) => list.filter((c: any) => c.id !== userId));
            }
            ...
            async function handleSetMute(mute: any, userId: any) {
